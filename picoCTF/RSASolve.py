from sage.all import * # sagemath is a math software system 
from pwn import *
from gmpy2 import is_prime
from string import ascii_letters, digits
from Crypto.Util.number import bytes_to_long, long_to_bytes, inverse

r = remote('saturn.picoctf.net', 62820) #this is just the instance that pico gave to us.
...
K = divisors(d*e - 1) # part of the various aspects of the RSA encrpytion system
print("Done")
